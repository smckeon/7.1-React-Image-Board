...
var ImageBoardContainer = React.createClass({
  ...
  componentWillMount: function(){
    ...
    //   {id: 1, url: 'http://unsplash.it/300/300', description: 'cool photo'},
    //   {id: 2, url: 'http://unsplash.it/300/301', description: 'another cool photo'}
    // ]);
  ...
  render: function(){
    return (
      <div className="container">
        ...
        {this.state.showForm ? <ImageForm imageToEdit={this.state.imageToEdit} addImage={this.addImage} editImage={this.editImage} /> : null}

        <ImageList imageCollection={this.state.imageCollection} showEditForm={this.showEditForm}
        />
      </div>
    )
  }
    ...
    return (
      <form onSubmit={this.handleSubmit} className="well">
        ...
        <div className="form-group">
          ...
          <input onChange={this.handleDescriptionChange} value={this.state.description} type="text" className="form-control" id="description" placeholder="Photo Description" />
        </div>
      ...
      return (
        <div key={image.cid} className="thumbnail">
          ...
          <div className="caption">
            ...
            <p>
              <a onClick={(e) => { e.preventDefault(); self.props.showEditForm(image); }}
